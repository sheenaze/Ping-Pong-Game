...
class PingPong:
    def __init__(self, window_width, window_height, window_color, paddles_color, ball_radius, ball_color, text_color):
        ...
        self.game_objects = CurrentGameObjectsFactory(window_width, window_height, paddles_color, ball_radius, ball_color, text_color)
        ...
        self.result_display = self.game_objects.print_result()
